...
async function main() {
  ...
  const vc1 = await prisma.vC.upsert({
    ...
    create: {
      ...
      fundSize: '$7.2B',
      focusAreas: ['AI', 'Blockchain', 'SaaS', 'FinTech'],
      stagePreference: ['MVP', 'GROWTH', 'SCALE'],
      investmentRangeMin: BigInt(500000),
      investmentRangeMax: BigInt(50000000),
      thesis: 'Software is eating the world. We invest in founders building category-defining companies.',
      portfolio: ['Airbnb', 'Stripe', 'Coinbase', 'Instacart'],
      personaName: 'Marc AI',
      ...
      priorities: ['Large TAM', 'Exceptional founders', 'Network effects', 'Technical moats'],
    },
  });
  ...
  const vc2 = await prisma.vC.upsert({
    ...
    create: {
      ...
      fundSize: '$8.5B',
      focusAreas: ['Enterprise SaaS', 'Consumer', 'HealthTech'],
      stagePreference: ['GROWTH', 'SCALE'],
      investmentRangeMin: BigInt(2000000),
      investmentRangeMax: BigInt(100000000),
      thesis: 'Help daring founders build legendary companies from idea to IPO and beyond.',
      portfolio: ['Apple', 'Google', 'PayPal', 'YouTube', 'WhatsApp'],
      ...
      priorities: ['Product-market fit', 'Unit economics', 'Team cohesion', 'Capital efficiency'],
    },
  });
  ...
  const vc3 = await prisma.vC.upsert({
    ...
    create: {
      ...
      fundSize: '$500M',
      focusAreas: ['AI', 'SaaS', 'Blockchain', 'HealthTech', 'FinTech', 'Climate Tech'],
      stagePreference: ['IDEA', 'MVP'],
      investmentRangeMin: BigInt(125000),
      investmentRangeMax: BigInt(500000),
      thesis: 'We help startups with funding, advice, and a strong alumni network.',
      portfolio: ['Airbnb', 'Stripe', 'Coinbase', 'Reddit', 'Instacart', 'DoorDash'],
      personaName: 'YC Bot',
      ...
      riskTolerance: 'AGGRESSIVE',
      priorities: ['Founder determination', 'Growth rate', 'Clear vision', 'Speed of execution'],
    },
  });
